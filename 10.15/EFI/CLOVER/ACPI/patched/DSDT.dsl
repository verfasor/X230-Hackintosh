 ...
 *
 * Disassembly of iASLflm9qE.aml, Wed Aug 28 05:42:22 2019
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000FC17 (64535)
 *     Revision         0x01 **** 32-bit table (V1), no 64-bit math support
 *     Checksum         0x4D
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "TP-G2   "
 *     OEM Revision     0x00002730 (10032)
 *     Compiler ID      "INTL"
 *     Compiler Version 0x20180427 (538444839)
 */
DefinitionBlock ("", "DSDT", 1, "LENOVO", "TP-G2   ", 0x00002730)
{
    ...
    OperationRegion (GNVS, SystemMemory, 0xDAB6CE18, 0x01C8)
    ...
    Scope (_SB)
    {
        Method (_INI, 0, NotSerialized)  // _INI: Initialize
        {
            ...
            Store (One, OSIF)
            Store (^PCI0.LPC.EC.ADP1._PSR (), PWRS)
            ^PCI0.LPC.MOU.MHID ()
            If (LNUX)
            {
            ...
            Store (SRU7, ^PCI0.EH01.RID)
            Store (SRU8, ^PCI0.EH02.RID)
            ...
            Method (GUSB, 1, NotSerialized)
            {
                If (H8DR)
                {
                    ...
                    If (LEqual (Arg0, Zero))
                    {
                        ...
                        If (LEqual (XHCM, Zero))
                        {
                            Notify (^^^EH01.URTH.URMH.PRT2, 0x03)
                        }
                        ElseIf (And (^^^XHCI.PR2, 0x04))
                        {
    ...
    Method (_WAK, 1, NotSerialized)  // _WAK: Wake
    {
        ...
        {
            NVSS (Zero)
            Store (\_SB.PCI0.LPC.EC.ADP1._PSR (), PWRS)
